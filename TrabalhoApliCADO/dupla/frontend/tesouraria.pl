...
form_tesouraria -->
    html(form([ id('bookmark-form'),
              ...
              [ \metodo_de_envio('POST'),
                    \campo(idempresa, 'ID Empresa', number),
                    \campo(idcliente, 'ID Cliente', number),
                    \campo(idplanoContas, 'ID Plano de Contas', number),
                    \campo(idfornecedores, 'ID Fornecedores', number),
